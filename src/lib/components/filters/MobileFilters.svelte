...
<button
    ...
    class="bg-[var(--yellow-color)] rounded-full w-12 h-12 flex items-center justify-center"
>
<svg class=" rotate-90 w-6 h-6" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="256" height="256" viewBox="0 0 256 256" xml:space="preserve">
    <defs>
    </defs>
