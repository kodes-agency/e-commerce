<script lang="ts">
  ...
  import { filterHeading, isCartOpen, cartStore, logoColor } from "$lib/store/store";
...
>
  <div class="flex flex-col space-y-5">
    <!-- Navigation links -->
    <div
      class="nav-animation text-center flex flex-col text-4xl lg:text-5xl space-y-2 pb-8"
    >
      <a
  ...
  <!-- Bottom modal links -->
  <div class="flex flex-col items-center space-y-4 nav-animation w-full">
    <div class="bg-black h-px w-full" />
    <a class="w-full text-center md:text-start pb-8 mb:pb-0" href="/privacy"
      >Общи условия и политика за бисквитките</a
    >
  </div>
</div>
