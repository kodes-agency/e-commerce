<script lang="ts">
  ...
  let lottie: HTMLElement;
  let text: HTMLElement;
  let stripeWrapper: HTMLElement;
...
<section
  class="bg-white w-full sm:w-[400px] flex flex-col items-center py-20 rounded-md space-y-5 p-5 md:p-10"
>
  <h2 class="text-xl font-medium">Данни за плащане</h2>

  <div class="flex flex-col items-center justify-center">
    <div bind:this={lottie} class="flex flex-col items-center justify-center">
        <Circle size="40" unit="px" color="rgb(59 130 246)"/> 
        <p class="p-1 text-sm">Установява се защитена връзка...</p>
    </div>
    <p bind:this={text} class="text-center text-sm opacity-0 hidden p-1">
      Осигурена е сигурна <br /> 2042 битова SSL връзка! <br />
      <strong>Вашите данни са защитени!</strong>
    </p>
  </div>
  <div bind:this={stripeWrapper} class="w-full opacity-30">
    <Stripe />
  </div>
  <span class="flex flex-col items-center">
    <p class="text-xs text-center">powered by</p>
    <svg
      class="w-[50px]"
      version="1.1"
      id="Layer_1"
